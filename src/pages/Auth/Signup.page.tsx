                ...
                <form className="mt-8 space-y-6"
                    ...
                    <div className=" flex flex-row items-center">
                        ...
                        <div className=" flex flex-row items-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-at-sign text-blue-700"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                            <input
                                id="email-address"
                                type="email"
                                autoComplete="email"
